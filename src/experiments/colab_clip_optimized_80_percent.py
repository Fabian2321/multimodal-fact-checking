...
def main():
    ...
    if metrics['accuracy'] >= 0.80:
        ...
        print(f"🚀 Congratulations! You've reached the 80% milestone!")
    else:
        print(f"📈 Close to target: {metrics['accuracy']*100:.1f}% (target: 80%)")
        print(f"💡 Try increasing NUM_CROPS or adjusting preprocessing")
